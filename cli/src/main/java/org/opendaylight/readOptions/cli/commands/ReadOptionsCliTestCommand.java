 ...
 */
package org.opendaylight.readOptions.cli.commands;
...
public class ReadOptionsCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ReadOptionsCliTestCommand.class);
    protected final ReadOptionsCliCommands service;

    public ReadOptionsCliTestCommand(final ReadOptionsCliCommands service) {
