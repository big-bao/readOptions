package org.opendaylight.readOptions.utils;
...
public final class OfActionUtils {
    ...
    public static Action outputAction(NodeConnectorId id) {
        return new OutputActionCaseBuilder()
                .setOutputAction(new OutputActionBuilder().setOutputNodeConnector(new Uri(id.getValue())).build())
                .build();
    }
    ...
    public static Action setDlSrcAction(String macStr) {
        return new SetDlSrcActionCaseBuilder()
                .setSetDlSrcAction(new SetDlSrcActionBuilder().setAddress(new MacAddress(macStr)).build()).build();
    }
    ...
    public static Action setNwSrcAction(Address ip) {
        return new SetNwSrcActionCaseBuilder().setSetNwSrcAction(new SetNwSrcActionBuilder().setAddress(ip).build())
                .build();
    }

    public static Action setNwDstAction(Address ip) {
        return new SetNwDstActionCaseBuilder().setSetNwDstAction(new SetNwDstActionBuilder().setAddress(ip).build())
                .build();
    }
    ...
    public static Action nxLoadRegAction(DstChoice dstChoice, BigInteger value, int endOffset, boolean groupBucket) {
        ...
        if (groupBucket) {
        	...
        	//return null;
        	NxActionRegLoadNodesNodeTableFlowApplyActionsCase h = new NxActionRegLoadNodesNodeTableFlowApplyActionsCaseBuilder().setNxRegLoad(r).build();
            return h;
        }
    }
    ...
    public static Action nxLoadArpOpAction(BigInteger value) {
    	Action h = nxLoadRegAction(new DstOfArpOpCaseBuilder().setOfArpOp(Boolean.TRUE).build(), value, 15, false);
        return h;
    }
    ...
    public static Action nxLoadArpShaAction(String macAddress) {
        return nxLoadArpShaAction(new MacAddress(macAddress));
    }
    ...
    public static Action nxMoveRegAction(SrcChoice srcChoice, DstChoice dstChoice, int srcStartOffset,
            int dstStartOffset, int dstEndOffset, boolean groupBucket) {
        NxRegMove r = new NxRegMoveBuilder()
                .setSrc(new SrcBuilder().setSrcChoice(srcChoice).setStart(srcStartOffset).build())
    ...
    public static Action nxOutputRegAction(SrcChoice srcChoice) {
        NxOutputReg r = new NxOutputRegBuilder()
                .setSrc(new org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extension.nicira.action.rev140714.nx.action.output.reg.grouping.nx.output.reg.SrcBuilder()
                        .setSrcChoice(srcChoice).setOfsNbits(31).build())
    ...
    public static Action nxSetNspAction(Long nsp) {
        return nxLoadRegAction(new DstNxNspCaseBuilder().setNxNspDst(Boolean.TRUE).build(),
                BigInteger.valueOf(nsp.longValue()), 23, false);
    }
    ...
    public static Action nxLoadNshMdtypeAction(Short value) {
        return nxLoadRegAction(new DstNxNshMdtypeCaseBuilder().setNxNshMdtype(Boolean.TRUE).build(),
                BigInteger.valueOf(value.longValue()), 7, false);
    }

    public static Action nxLoadNshNpAction(Short value) {
        return nxLoadRegAction(new DstNxNshNpCaseBuilder().setNxNshNp(Boolean.TRUE).build(), BigInteger.valueOf(value),
                7, false);
    }

    public static Action nxLoadTunGpeNpAction(Short value) {
        return nxLoadRegAction(new DstNxTunGpeNpCaseBuilder().setNxTunGpeNp(Boolean.TRUE).build(),
                BigInteger.valueOf(value), 7, false);
    }

    public static Action nxSetNsiAction(Short nsi) {
        return nxLoadRegAction(new DstNxNsiCaseBuilder().setNxNsiDst(Boolean.TRUE).build(),
                BigInteger.valueOf(nsi.longValue()), 7, false);
    }

    public static Action nxLoadNshc1RegAction(Long value) {
        return nxLoadRegAction(new DstNxNshc1CaseBuilder().setNxNshc1Dst(Boolean.TRUE).build(),
                BigInteger.valueOf(value.longValue()), 31, false);
    }

    public static Action nxLoadNshc2RegAction(Long value) {
        return nxLoadRegAction(new DstNxNshc2CaseBuilder().setNxNshc2Dst(Boolean.TRUE).build(),
                BigInteger.valueOf(value.longValue()), 31, false);
    }

    public static Action nxLoadNshc3RegAction(Long value) {
        return nxLoadRegAction(new DstNxNshc3CaseBuilder().setNxNshc3Dst(Boolean.TRUE).build(),
                BigInteger.valueOf(value.longValue()), 31, false);
    }

    public static Action nxLoadNshc4RegAction(Long value) {
        return nxLoadRegAction(new DstNxNshc4CaseBuilder().setNxNshc4Dst(Boolean.TRUE).build(),
                BigInteger.valueOf(value.longValue()), 31, false);
    }
    ...
    public static Action nxMoveNshc1ToTunIpv4Dst() {
        return nxMoveRegAction(new SrcNxNshc1CaseBuilder().setNxNshc1Dst(Boolean.TRUE).build(),
                new DstNxTunIpv4DstCaseBuilder().setNxTunIpv4Dst(Boolean.TRUE).build(), 31, false);
    }

    public static Action nxMoveNshc2ToTunId() {
        return nxMoveRegAction(new SrcNxNshc2CaseBuilder().setNxNshc2Dst(Boolean.TRUE).build(),
    ...
    public static Action nxMultipathAction(OfjNxHashFields fields, Integer basis, OfjNxMpAlgorithm algorithm,
            Integer maxLink, Long arg, DstChoice dstChoice, Integer start, Integer end) {
        NxMultipath r = new NxMultipathBuilder().setFields(fields).setBasis(basis).setAlgorithm(algorithm)
                .setMaxLink(maxLink).setArg(arg)
                .setDst(new org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extension.nicira.action.rev140714.nx.action.multipath.grouping.nx.multipath.DstBuilder()
                        .setDstChoice(dstChoice).setStart(start).setEnd(end).build())
                .build();
     ...
     *            the conntrackZone
     * @param recircTable
     *            the recirc table if it is a recirc action
     * @return the conntrack action.
     */
    public static Action nxConntrackAction(Integer flags, Long zoneSrc, Integer conntrackZone, Short recircTable) {
        NxConntrack r = new NxConntrackBuilder().setFlags(flags).setZoneSrc(zoneSrc).setConntrackZone(conntrackZone)
                .setRecircTable(recircTable).build();
